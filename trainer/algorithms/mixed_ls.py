...
def train_mixed_ls(model: nn.Module, train_dataset: DataLoaderType, validate_dataset: DataLoaderType, 
    ...
    """
    Function implements LS method, where hessian is mixed hessian. Method implies computation of the mixed Hessian and
    ...
    # while grad_norm is None or grad_norm >= min_grad_norm:
        ...
        # Calculate and apply LS step with mixed hessian
        hess_inv = torch.linalg.pinv(hess, rcond=1e-12, hermitian=True)
    ...
    return None, best_criterion_test